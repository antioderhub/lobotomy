...
local Window = OrionLib:MakeWindow({Name = "Key Guardian Creator | Orion | Executor: "..identifyexecutor(), HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest", IntroText = "Aftr Lua was there..."})
...
local scr = local KeyGuardian = loadstring(game:HttpGet('https://cdn.keyguardian.org/library/v2.lua'))();KeyGuardian:Set({ServiceToken = pubt;APIToken = pt});local Key = "";
...
-- DO NOT CHANGE ANYTHING UNDER THIS, ONLY CHANGE THE LINE "-- put your script here"!!!!!!
-- DO NOT CHANGE ANYTHING UNDER THIS, ONLY CHANGE THE LINE "-- put your script here"!!!!!!
local MT = getmetatable(KeyGuardian.Checks);local A, B, C = KeyGuardian.Checks.EQ(Key);if KeyGuardian:ValidateKey(Key) then;if;not ((getfenv(KeyGuardian.Sanity)["KeyGuardian"]["math.random"]["RNG1"]["NUM"]) ~= (getfenv(KeyGuardian.Sanity)["KeyGuardian"]["math.random"]["RNG1"]["NUM"]));and not ((getfenv(KeyGuardian.Sanity)["KeyGuardian"]["math.random"]["RNG2"]["NUM"]) ~= (getfenv(KeyGuardian.Sanity)["KeyGuardian"]["math.random"]["RNG2"]["NUM"]));and not ((getfenv(KeyGuardian.Sanity)["KeyGuardian"]["math.random"]["os.time()"]()) ~= (getfenv(KeyGuardian.Sanity)["KeyGuardian"]["math.random"]["os.time()"]()));and not ((getfenv(KeyGuardian.Sanity)["KeyGuardian"]["math.random"]["tick"]()) ~= (getfenv(KeyGuardian.Sanity)["KeyGuardian"]["math.random"]["os.time()"]()));and not ((getfenv(KeyGuardian.Sanity)["KeyGuardian"]["Premium"]["Value"]) ~= (getfenv(KeyGuardian.Sanity)["KeyGuardian"]["Premium"]["Value"]));and not ((getfenv(KeyGuardian.Sanity)["KeyGuardian"]["Premium"]["NotPremium"]) ~= true);and not ((getfenv(KeyGuardian.Sanity)["KeyGuardian"]["SHA256"]["Decoded"]) ~= (getfenv(KeyGuardian.Sanity)["KeyGuardian"]["SHA256"]["Decoded"]));and not ((getfenv(KeyGuardian.Sanity)["KeyGuardian"]["SHA256"]["Encoded"]()) ~= (getfenv(KeyGuardian.Sanity)["KeyGuardian"]["SHA256"]["Encoded"]()))
